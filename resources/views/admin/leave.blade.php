                        ...
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    ...
                                    @if($list->lineManagerStatus == 1 || ($list->reliefStatus ==1 && $list->user->userType == 'Line Manager'))
                                    ...
                                    <td>{{$list->user->lastName . " ". $list->user->lastName}}</td> 
                                        ...
                                        @endif
                                        @if($list->AdminStatus == 0)
                                        <td>
                                            <span class="text-primary">Waiting For Approval</span>
                                        </td>
                                        @elseif($list->AdminStatus == 1)
                                        <td>
                                            <span class="text-success">Approved</span>
                                        </td>
                                        @else
                                        ...
                                        @endif
                                        <td class="btn btn-primary bg-primary"> <a style="text-decoration: none; color:white" href="{{route('admin-leave-details', $list->id)}}">View Details</a></td>
                                    </tr>
                                    @endif
                                    @endforeach
                                </tbody>
